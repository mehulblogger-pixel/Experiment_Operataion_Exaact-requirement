...
<div class="panel" style="padding:0;overflow:hidden">
  ...
  <table class="dt">
    <thead><tr><th>ER No.</th><th>Vendor</th><th>PO / project</th><th>Progress</th><th>Status</th><th>Required</th><th>Forecast</th><th>Δ days</th><th>Date</th></tr></thead>
    <tbody>
      <?php if (!$rows): ?><tr><td colspan="9" class="muted" style="padding:16px">No expediting reports yet. Create one with type <strong>Expediting Report</strong> against a vendor and PO.</td></tr><?php endif; ?>
