<?php
  ...
  $allowPerms = $globalMgr ? PERMISSIONS : array_intersect_key(PERMISSIONS, array_flip(['dash.operations','dash.utilization','data.credit','ops.call.create','ops.job.allocate','ops.job.close','master.manage']));
