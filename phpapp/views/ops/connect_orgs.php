...
<div class="master-head">
  <div><h1>Organisations</h1>
    <p class="sub" style="margin:2px 0 0">Each organisation on the platform carries a type, and the type sets which modules it gets — a TPIA gets the full operations platform, a manpower agency the marketplace. Everyone shares the professional pool; private data stays private (Phase B design).</p></div>
</div>
...
<div class="panel" style="margin-top:12px">
  ...
  <?php else: ?>
    <div class="tbl-wrap"><table class="tbl">
      <thead><tr><th>Organisation</th><th>Type</th><th>Package</th><th>Modules (entitlement)</th></tr></thead>
      <tbody>
