...
<div class="master-head">
  ...
  <?php if (is_coordinator_level()): ?><a class="btn" href="/requisition-new">➕ <?= e(function_exists('T_NEW') ? ucfirst(T_NEW('requisition')) : 'New requisition') ?></a><?php endif; ?>
</div>
...
<div class="panel" style="padding:0;overflow:hidden">
  <?php if (!$rows): ?>
    <div style="text-align:center;padding:34px"><div style="font-size:32px">📋</div>
      <p class="muted" style="margin:8px 0 0">No <?= e(function_exists('Tlp') ? Tlp('requisition') : 'requisitions') ?> yet. <?php if (is_coordinator_level()): ?><a href="/requisition-new">Raise the first</a>.<?php endif; ?></p></div>
  <?php else: ?>
  <table class="dt">
