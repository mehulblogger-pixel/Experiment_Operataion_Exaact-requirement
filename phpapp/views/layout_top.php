...
<header class="topbar">
  ...
  <?php if ($u): ?>
  <button class="nav-toggle" id="navToggle" aria-label="Menu" aria-expanded="false" onclick="var w=document.getElementById('navWrap');var o=w.classList.toggle('open');this.setAttribute('aria-expanded',o);this.innerHTML=o?'✕':'☰';">☰</button>
  <div class="nav-wrap" id="navWrap">
    ...
    <span class="user"><span class="who"><?= e(user_name($u)) ?> · <?= e(role_label($u)) ?></span>
