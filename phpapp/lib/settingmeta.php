...
function setting_meta_all() {
    return [
        ...
        'finance_truth_unified'      => ['Unified financial truth (§28)', 'Makes the MIS dashboard, the SBU-P&L contract table and the owner/boss view all read the one canonical job_profit engine instead of their own partial formulas. CHANGES DISPLAYED PROFIT (downward, to the true figure — overhead/vouchers/contingency/recovered were being dropped). Default OFF; review the before/after preview on Profitability before turning it on.', ['Management dashboard (Module 34)', 'SBU P&L (Module 32)', 'Owner/boss profitability'], 'live', 'high'],
