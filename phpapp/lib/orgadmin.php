...
function org_start_here() {
    ...
    return [
        ...
        ['n'=>2, 'title'=>'Check the designation list',
         ...
         'done'=>$desig > 0, 'state'=>$desig . ' on the list', 'href'=>'/lookup?key=designation', 'cta'=>'Open the master'],
        ['n'=>3, 'title'=>'Check the ' . Tlp('sbu') . ' list',
         ...
         'done'=>$sbus > 0, 'state'=>$sbus . ' on the list', 'href'=>'/lookup?key=sbu', 'cta'=>'Open the master'],
