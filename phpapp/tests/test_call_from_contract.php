...
if (can('ops.call.create') || is_master()) {
    ...
    t_ok($order['cta'] !== '', 'a "raise call" action is offered to someone who can raise calls');
}
// The step never says "inspection inspection" — the call word is already "…call".
...
$pbF = crm_quote_playbook(['id' => 0, 'status' => 'ACCEPTED', 'contract_number' => 'CON/2026/0009']);
