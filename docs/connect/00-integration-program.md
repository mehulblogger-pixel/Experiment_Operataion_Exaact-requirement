...
| **K2b** | External self-service — expose "post" to the client portal and "apply" to the vendor/inspector portal | EXTEND | 5a (role→portal mapping + new portal permissions) |
