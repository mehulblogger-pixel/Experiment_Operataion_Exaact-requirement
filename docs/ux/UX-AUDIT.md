...
| **F-A5-1** ⚠ *corrected — see UX-B6 §1; only the Engineer ADD screen was right, and Candidate was the opposite of what this row claims* | Job 57, Test request 54, Engineer 48, User 40 | Every field shown at once | Part 9's "wall of fields"; four of the most-used forms | structural | HIGH | medium |
