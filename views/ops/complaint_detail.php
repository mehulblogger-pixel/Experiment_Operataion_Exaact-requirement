...
<div class="panel">
  ...
  <p class="sub" style="margin-top:0">ISO/IEC 17020 §7.5.4 — the decision has to be made by, or reviewed and approved
    by, somebody who was not involved in the inspection being complained about.
    <?= $c['kind'] === 'APPEAL' ? ' §7.6 adds whoever decided the original.' : '' ?></p>
  <?php if ($involved): ?>
